...
function publicConcept(concept) {
  return {
    ...
    owner_mode: concept.owner_mode || "none",
    owner_requirement_reason: concept.owner_requirement_reason || "",
    post_format: concept.post_format || "single",
    carousel_fit_score: Number(concept.carousel_fit_score || 0),
    preferred_slide_count: Number(concept.preferred_slide_count || 1),
    carousel_reason: concept.carousel_reason || "",
    carousel_storyboard_type: concept.carousel_storyboard_type || "progression",
